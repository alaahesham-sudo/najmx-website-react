...
export default function Cta() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const deptEmails: { [key: string]: string } = {
      sales: "sales@najmx.net",
      support: "support@najmx.net",
      general: "info@najmx.net",
    };
    
    const toEmail = deptEmails[formData.department] || "info@najmx.net";
    const subject = `${formData.service || "Contact"} - ${formData.name} from ${formData.company}`;
    const body = `Name: ${formData.name}%0D%0AEmail: ${formData.email}%0D%0ACompany: ${formData.company}%0D%0APhone: ${formData.phone || "Not provided"}%0D%0AService Interest: ${formData.service}%0D%0A%0D%0AMessage:%0D%0A${formData.message}`;
        ...
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl">
            ...
            <form 
              ...
              className="rounded-2xl bg-gradient-to-br from-gray-900/50 via-gray-800/25 to-gray-900/50 p-8 border border-gray-800"
            >
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  ...
                  >
                    ...
                    <option value="NajmVoIP">NajmVoIP - Voice & Call Center Solutions</option>
